...
## manual: /smartspec\_project\_copilot version: 5.7 compatible\_workflow\_versions: 5.6.x language: th role: คู่มือการใช้งาน Project-level advisor / workflow router / roadmap planner
