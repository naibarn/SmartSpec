...
- `specs/feature/spec-004/tasks.md --specindex=".spec/SPEC_INDEX.json"`
...
- SPEC_INDEX: auto-detect `.spec/SPEC_INDEX.json` (canonical), then `SPEC_INDEX.json` (legacy root mirror), then `.smartspec/SPEC_INDEX.json` (deprecated)

## 0. Load Context

**Read project index/registry context:**
- If user provides `--specindex="path"`: Load from specified path
- Else: Auto-detect SPEC_INDEX in this order: `.spec/SPEC_INDEX.json` → `SPEC_INDEX.json` (legacy root mirror) → `.smartspec/SPEC_INDEX.json` (deprecated)
