...
- Reports: `.smartspec/reports/security-audit/**`
...
- `.smartspec/reports/security-threat-model/**/threats.md`: Primary threat model input generated by `smartspec_security_threat_modeler`.
- `specs/**/tasks.md`: Used to find mitigation tasks linked to the threats.
- `.smartspec/reports/verify-tasks-progress-strict/**/summary.json`: Used as verification evidence (see Evidence selection).
...
- `--threats <path>`: Optional explicit path to a threat model `threats.md` under `.smartspec/reports/security-threat-model/**`. If provided, it is used as the **sole** threat source.
...
- Search under `.smartspec/reports/security-threat-model/**/threats.md`.
...
- The file resides under `.smartspec/reports/security-threat-model/`.
...
- Search under `.smartspec/reports/verify-tasks-progress-strict/**/summary.json`.
...
- Default root: `.smartspec/reports/security-audit/<run-id>/...`
...
3. **Build Mitigation Map**: For each task, parse `Mitigates:` line(s) and map threat IDs → task IDs.
