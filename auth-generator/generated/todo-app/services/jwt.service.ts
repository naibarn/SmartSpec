...
export class JWTService {
  ...
  constructor() {
    ...
    this.algorithm = (process.env.JWT_ALGORITHM || 'RS256') as jwt.Algorithm;
    this.issuer = process.env.JWT_ISSUER || 'smartspec-app';
    this.audience = process.env.JWT_AUDIENCE || 'smartspec-users';
  ...
  generateTokenPair(userId: string, email: string, role: UserRole): TokenPair {
    const payload: { userId: string; email: string; role: UserRole } = {
      userId,
      email,
      role
    };
