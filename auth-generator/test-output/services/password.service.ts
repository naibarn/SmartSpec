...
export class PasswordService {
  ...
  constructor() {
    ...
    this.requirements = {
      ...
      requireUppercase: process.env.PASSWORD_REQUIRE_UPPERCASE === 'true' || false,
      requireLowercase: process.env.PASSWORD_REQUIRE_LOWERCASE === 'true' || false,
      requireNumbers: process.env.PASSWORD_REQUIRE_NUMBERS === 'true' || false,
      requireSpecialChars: process.env.PASSWORD_REQUIRE_SPECIAL === 'true' || false
    };
  }
